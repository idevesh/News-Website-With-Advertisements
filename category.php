...
<html lang="en">
  ...
  <head>
    ...
    <title>Category Page | TrueIndia </title>
...
<h1><?php echo htmlentities($row['category']);?> News</h1>
       ...
       <img class="card-img-top" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>">
            <div class="card-body">
              ...
              <a href="news-details.php?title=<?php echo htmlentities($row['url'])?>&nid=<?php echo htmlentities($row['pid'])?>" class="btn btn-primary">Read More &rarr;</a>
            </div>
