...
if (strlen($_SESSION['login']) == 0) {
    ...
    <html lang="en">
        <head>
            ...
            <title>Dashboard | TrueIndia</title>
                                ...
                                <a href="trash-posts.php"> <div class="col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                        <div class="card-box widget-box-one">
                                            <i class="mdi mdi-chart-areaspline widget-one-icon"></i>
                                            <div class="wigdet-one-content">
                                                <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="Statistics">Total Views</p>
                                                <?php
                                                $query = mysqli_query($con, "select sum(views) as views from tblposts");
                                                $row = mysqli_fetch_array($query);
                                                ?>

                                                <h2><?php echo htmlentities($row['views']); ?> <small></small></h2>
