...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['sucatdescription'])) {
        ...
        $query = mysqli_query($con, "update tblsubcategory set CategoryId='$categoryid',Subcategory='$subcatname',UpdationDate='$currentTime',SubCatDescription='$subcatdescription' where SubCategoryId='$subcatid'");
        if ($query) {
    ...
    <html lang="en">
        <head>
            ...
            <title>Edit Sub Category | TrueIndia</title>
