...
$currentTime = date('d-m-Y h:i:s A', time());
        ...
        $status = 1;
        $query = mysqli_query($con, "insert into tblsubcategory(CategoryId,Subcategory,SubCatDescription,Is_Active,PostingDate) values('$categoryid','$subcatname','$subcatdescription','$status','$currentTime')");
        if ($query) {
    ...
    <html lang="en">
        <head>
            ...
            <title>Add Sub Category | TrueIndia</title>
