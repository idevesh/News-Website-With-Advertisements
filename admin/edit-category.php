...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "Update  tblcategory set CategoryName='$category',UpdationDate='$currentTime',Description='$description' where id='$catid'");
        if ($query) {
    ...
    <html lang="en">
        <head>
            <title>Add Category | TrueIndia</title>
